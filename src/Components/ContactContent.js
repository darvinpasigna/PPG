...
<div className="container contact">
   ...
   <div className='row'>
    <div className="col-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="lightgray" className="bi bi-telephone" viewBox="0 0 16 16">
    ...
    <div className="col-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="white"className="bi bi-envelope-at" viewBox="0 0 16 16">
    ...
    <div className="col-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="blue"className="bi bi-messenger" viewBox="0 0 16 16">
          ...
          <a href="#">m.me/PPGgameshop</a><br />
          <a href="#">instagram.com/yourpage</a>
          </h5>
    </div>
   </div>
</div>
